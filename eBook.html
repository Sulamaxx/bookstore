...
-->
  ...
  <body>
      ...
      <div class="container pb-5">
        <div class="row">
          ...
          <div class="col-lg-12 mt-5">
            <div class="card">
              <div class="card-body">
                <h3 class="h2">Lord of the rings</h3>
                <div id="pdf-viewer"></div>
                <iframe src="Lab_01.pdf" width="100%" height="700px"></iframe>
              </div>
            </div>
          </div>
        </div>
    ...
    <script>
      ...
      // Disable right-click context menu on the PDF viewer
      document
